 ...
 */
public class ApplicantsTable extends Table {
    private final MainLayout main;


    public ApplicantsTable(MainLayout main) {
        this.main = main;
        setSizeFull();
        ...
        Set<Person> applicants = PeopleFacade.personService.getPersonsWithRole("HASHCODE", RolesValues.ROLE_PROSPECT.name());
