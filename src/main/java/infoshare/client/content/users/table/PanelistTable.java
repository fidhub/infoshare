 ...
 */
public class PanelistTable extends Table {
    private final MainLayout main;


    public PanelistTable(MainLayout main) {
        this.main = main;
        setSizeFull();
        ...
        Set<Person> applicants = PeopleFacade.personService.getPersonsWithRole(main.company, RolesValues.ROLE_PROSPECT.name());
