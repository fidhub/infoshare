 ...
 */
public class TrainersTable extends Table {
    private final MainLayout main;

    public TrainersTable(MainLayout main) {
        this.main = main;
        setSizeFull();
        ...
        Set<Person> applicants = PeopleFacade.personService.getPersonsWithRole("HASHCODE", RolesValues.ROLE_TRAINER.name());


        applicants.parallelStream().forEach(item -> {
            System.out.println(" THE name is " + item.getEmailAddress());
