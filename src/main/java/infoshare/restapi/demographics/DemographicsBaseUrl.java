...
public class DemographicsBaseUrl {
    public static class Gender{
        ...
        public static final String GET_ID = RestUtil.URL + "  /api/demographics/gender/get/:id ";
    ...
    public static class Language{
        ...
        public static final String GET_ID = RestUtil.URL + "  /api/demographics/language/get/:id ";
    ...
    public static class LanguageProficiency{
        ...
        public static final String GET_ID = RestUtil.URL + "  /api/demographics/languagep/get/:id ";
    ...
    public static class Race{
        ...
        public static final String GET_ID = RestUtil.URL + "  /api/demographics/race/get/:id ";
    ...
    public static class Roles{
        ...
        public static final String GET_ID = RestUtil.URL + "  /api/demographics/role/get/:id ";
