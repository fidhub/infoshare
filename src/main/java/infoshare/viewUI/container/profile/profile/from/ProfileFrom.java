package infoshare.viewUI.container.profile.profile.from;
...
public class ProfileFrom extends FormLayout {
    ...
    public ProfileFrom() {
        ...
        Panel panel = new Panel(person.getFirstName().toUpperCase()+" "+person.getLastName().toUpperCase()+" 'S PROFILE SUMMARY");
